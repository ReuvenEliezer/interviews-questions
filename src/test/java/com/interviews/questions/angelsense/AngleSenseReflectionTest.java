...
public class AngleSenseReflectionTest {
    ...
    public void angleSenseReflectionTest() throws Exception {
        List<com.interviews.questions.angelsense.Name> friends = new ArrayList<>();
        friends.add(new com.interviews.questions.angelsense.Name("A", "AA", List.of("a", "b")));
        friends.add(new com.interviews.questions.angelsense.Name("B", "BB", List.of("a", "b")));
        com.interviews.questions.angelsense.Person person = new Person(35, new Name("Doron", "Somer", List.of("a", "b")), new String[]{"address1", "address2"}, friends);
        System.out.println(printObject(person));
    }

    @Test
    public void nodeTest() throws Exception {
        com.interviews.questions.angelsense.Node node = new com.interviews.questions.angelsense.Node(1, List.of("a", "b"));
        node.next = new com.interviews.questions.angelsense.Node(2, List.of("c", "d"));
        node.next.next = new com.interviews.questions.angelsense.Node(3);
        node.next.next.next = new com.interviews.questions.angelsense.Node(4);
        node.next.next.next.next = new com.interviews.questions.angelsense.Node(5);
